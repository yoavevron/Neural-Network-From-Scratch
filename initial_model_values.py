...
def xavier_weights_init(inputsize, hidden_layers, output_size):
...
def ha_weights_init(inputsize, hidden_layers, output_size):
    neurons = np.zeros(hidden_layers)
    weights = np.zeros(hidden_layers)
    bias = np.zeros(hidden_layers)
    return neurons, weights, bias

def xavier_bias_init(inputsize, hidden_layers, output_size):
    neurons = np.zeros(hidden_layers)
    weights = np.zeros(hidden_layers)
    bias = np.zeros(hidden_layers)
    return neurons, weights, bias

def ha_bias_init(inputsize, hidden_layers, output_size):
    neurons = np.zeros(hidden_layers)
    weights = np.zeros(hidden_layers)
    bias = np.zeros(hidden_layers)
    return neurons, weights, bias
